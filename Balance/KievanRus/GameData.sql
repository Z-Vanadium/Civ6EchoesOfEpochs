...
-- trade gold to +1 gold/10 tiles
UPDATE ModifierArguments SET Value=0.1 WHERE ModifierId = 'MODIFIER_MER_VARANGIANS_TO_THE_GREEKS_GOLD_DISTANT_TRADE' AND Name = 'Amount';
...
('VAN_VECHE_CULTURE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 0, 0, 0, 'BBG_UTILS_PLAYER_HAS_CIVIC_DEFENSIVE_TACTICS_REQSET', 'BBG_DISTRICT_IS_DISTRICT_MER_KYIV_VECHE_REQSET');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('VAN_VECHE_CULTURE', 'Amount', '1'), 
