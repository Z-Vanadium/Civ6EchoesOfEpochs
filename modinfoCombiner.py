...
<Mod id="7b2fd0cc-894e-11f0-848b-743af48c76b0" version="151">
  <Properties>
    <Name>CCB 适配：扩展包 纪元回响 Echoes Of Epochs 1.5.1 WIP</Name>
    <Description>【CCB 适配：扩展包 纪元回响 Echoes Of Epochs】是一个强度适配 CCB 的文明 6 PVP 领袖扩展包模组，包含 10 个新领袖、5 个新文明。所有美术素材均来自创意工坊同名优秀模组，在此向原作者表达感谢！
