...
<Mod id="7b2fd0cc-894e-11f0-848b-743af48c76bf" version="120">
  <Properties>
    <Name>CCB 适配：扩展包 纪元回响 Echoes Of Epochs 1.2.0</Name>
    <Description>【CCB 适配：扩展包 纪元回响 Echoes Of Epochs】是一个强度适配 CCB 的文明 6 PVP 领袖扩展包模组，包含 7 个新领袖、3 个新文明。所有美术素材均来自创意工坊同名优秀模组，在此向原作者表达感谢！
